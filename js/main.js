...
// ----- END OF jQuery.textcomplete code --------------------------------------------
    ...
    $('#myTextArea').textcomplete(
        [{
            ...
            search: function(term, callback) {
                ...
                $.getJSON('http://www.jarosciak.com/textentry/api/dictionary.php?q='+term.toLowerCase(), function(data) {
                    items = data;
                });
            ...
            */
                ...
                if (lastWord) {
                    if (lastWord.length >= 2) {
                        ...
                        var urlsuggest = 'http://www.jarosciak.com/textentry/api/dictionary.php?q='+lastWord;
                        ...
                        //response($.ui.autocomplete(availableTags));
